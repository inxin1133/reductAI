...
>
> **공식 문서**: [Platform 문서](https://developers.openai.com/api/docs) · [모델 목록](https://platform.openai.com/api/docs/models) · [Responses API](https://platform.openai.com/api/docs/guides/migrate-to-responses) · [Structured outputs](https://platform.openai.com/api/docs/guides/structured-outputs) · [GPT-5 mini](https://platform.openai.com/api/docs/models/gpt-5-mini)
