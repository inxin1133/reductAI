...
VALUES
    ('free', 'Free', 'free', 'personal', 'Free plan', 1, 1, 1, 0, 500, TRUE, 1, '{}'::jsonb),
    ('pro', 'Pro', 'pro', 'personal', 'Pro plan', 1, 1, 1, 0, 10240, TRUE, 2, '{}'::jsonb),
    ('premium', 'Premium', 'premium', 'team', 'Premium plan', 5, 1, 8, 5, 51200, TRUE, 3, '{}'::jsonb),
    ('business', 'Business', 'business', 'group', 'Business plan', 10, 1, 48, 5, 102400, TRUE, 4, '{}'::jsonb),
