...
import internalCreditRoutes from "./routes/internalCreditRoutes"
import publicCreditRoutes from "./routes/publicCreditRoutes"
...
app.use("/api/ai/credits/internal", requireServiceKey, internalCreditRoutes)
app.use("/api/ai/credits/my", requireAuth, publicCreditRoutes)
