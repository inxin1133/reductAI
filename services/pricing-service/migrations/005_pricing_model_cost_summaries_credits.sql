-- ============================================
-- Migration: pricing_model_cost_summaries 뷰 - credit 단위 적용
-- USD 1 = 1000 credits 기준으로 모든 cost 컬럼에 1000x 적용
--
-- 실행: psql $DATABASE_URL -f services/pricing-service/migrations/005_pricing_model_cost_summaries_credits.sql
-- ============================================
...
COMMENT ON VIEW pricing_model_cost_summaries IS 'User-facing price summary (all modalities) in credits. USD 1 = 1000 credits.';
