  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Bot,
        items: [
          { title: "AI 제공업체(ai_providers)", href: "/admin/ai/providers" },
          { title: "AI API Key(provider_api_credentials)", href: "/admin/ai/credentials" },
          { title: "출력 계약(response_schemas)", href: "/admin/ai/response-schemas" },
          { title: "프롬프트 템플릿(prompt_templates)", href: "/admin/ai/prompt-templates" },
          { title: "AI 모델 관리(ai_models)", href: "/admin/ai/models" },
          { title: "모델 라우팅 규칙(model_routing_rules)", href: "/admin/ai/model-routing-rules" },
          { title: "모델 API 프로필(model_api_profiles)", href: "/admin/ai/model-api-profiles" },
          { title: "제공업체 인증 프로필(provider_auth_profiles)", href: "/admin/ai/provider-auth-profiles" },
          { title: "예시 프롬프트(prompt_suggestions)", href: "/admin/ai/prompt-suggestions" },
          { title: "플랜별 모델 접근(plan_model_access)", href: "/admin/ai/plan-model-access" },
          { title: "모델 접근 권한(tenant_model_access)", href: "/admin/ai/model-access" },
          { title: "웹검색 정책(ai_web_search_settings)", href: "/admin/ai/web-search-settings" },
          { title: "모델 사용 로그(model_usage_logs)", href: "/admin/ai/model-usage-logs" },
        ]
      },
      {
        title: "가격/요율 관리",
